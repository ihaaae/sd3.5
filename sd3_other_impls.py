...
class SD3Tokenizer:
    def __init__(self):
        clip_tokenizer = CLIPTokenizer.from_pretrained("openai/clip-vit-large-patch14", cache_dir="/home/lxc/cache", use_safetensors=True)
...
class T5XXLTokenizer(SDTokenizer):
    ...
    def __init__(self):
        super().__init__(
            pad_with_end=False,
            tokenizer=T5TokenizerFast.from_pretrained("google/t5-v1_1-xxl", cache_dir="/home/lxc/cache", use_safetensors=True),
